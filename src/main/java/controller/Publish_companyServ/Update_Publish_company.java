...
/**
 * Servlet implementation class Update_Publish_company
 */
public class Update_Publish_company extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public Update_Publish_company() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		request.setAttribute("publish_company", a);
		request.getRequestDispatcher("Update_Publish_company.jsp").forward(request, response);
	}
