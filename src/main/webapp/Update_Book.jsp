	...
	<div class="body">
            ...
            <div class="sign_up__wrapper">
                <div class="sign_up__container">
                    ...
                    <form action="update_book" method="post" class="form" id="form-1">
                        <div class="sign_up-infor-div">
                            <div class="sign_up-infor">
                                <label for="id_book">Id book</label>
                                <input type="text" name="id_book" id="id_book" placeholder="Id book" value="${book.id }" readonly="readonly"">
                            </div>
                        ...
                        <div class="sign_up-infor-div">
                            <div class="sign_up-infor">
                                ...
                                <input type="text" name="name_book" id="name_book" placeholder="Name book" value="${book.name }">
                            </div>
                            <span class="form-mesg">
                        ...
                        <div class="sign_up-infor-div">
                            <div class="sign_up-infor">
                                ...
                                <input type="text" name="price_book" id="price_book" placeholder="Price book" value="${book.origin_price }">
                            </div>
                            <span class="form-mesg">
                        ...
                        <div class="sign_up-infor-div">
                            <div class="sign_up-infor">
                                ...
                                <input type="text" name="discount" id="discount" placeholder="Discount" value="${book.ratio_sale }">
                            </div>
                            <span class="form-mesg">
                        ...
                        <div class="sign_up-infor-div">
                            <div class="sign_up-infor">
                                ...
                                <input type="text" name="year_publish" id="year_publish" placeholder="Year publish book" value="${book.year_publish }">
                            </div>
                            <span class="form-mesg">
                        ...
                        <div class="sign_up-infor-div">
                            <div class="sign_up-infor">
                                ...
                                <textarea style="width: 308px; height: 150px;" rows="" cols="" name="content_book" id="content_book" placeholder="Content book">${book.content }</textarea>
                            </div>
                            <span class="form-mesg">
                        ...
                        <div class="sign_up-infor-div">
                            <div class="sign_up-infor">
                                ...
                                <input type="text" name="quantity_book" id="quantity_book" placeholder="Quantity book" value="${book.quantity }">
                            </div>
                            <span class="form-mesg">
                        ...
                        <div class="sign_up-infor-div">
                            <div class="sign_up-infor">
                                ...
                                <input type="text" name="img_book" id="img_book" placeholder="Link image" value="${book.img }">
                            </div>
                            <span class="form-mesg">
	                        ...
	                        <div class="sign_up-infor-div">
	                            ...
	                            <select name="NXB" id="NXB" style="height: 40px; width: 308px; text-align: center;">
	                                ...
	                                <c:forEach items="${pc.all }" var="o">
		                                <option ${(o.id == book.publish_company.id) ? 'selected' : ''} value="${o.id }">
		                                    ${o.name }
		                                </option>
	                                </c:forEach>
	                            </select>
	                        ...
	                        <div class="sign_up-infor-div">
	                            ...
	                            <select name="category" id="category" style="height: 40px; width: 308px; text-align: center;">
	                                ...
	                                <c:forEach items="${c.all }" var="o">
		                                <option ${(o.id == book.category.id) ? 'selected' : ''} value="${o.id }">
		                                    ${o.name }
		                                </option>
	                                </c:forEach>
	                            </select>
