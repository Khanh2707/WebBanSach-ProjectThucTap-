                    ...
                    <form action="update_publish_company" method="post" class="form" id="form-1">
                        <div class="sign_up-infor-div">
                            <div class="sign_up-infor">
                                ...
                                <input type="text" name="id_publish_company" id="id_publish_company" placeholder="Id Publish company" value="${publish_company.id }" readonly="readonly"">
                            </div>
                        ...
                        <div class="sign_up-infor-div">
                            <div class="sign_up-infor">
                                ...
                                <input type="text" name="name_publish_company" id="name_publish_company" placeholder="Name Publish company" value="${publish_company.name }">
                            </div>
                            <span class="form-mesg">
